...
export default function AdminLicenciaDetallePage({ params }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Link href="/panel/admin/licencias" className="flex items-center gap-2 text-sm opacity-70 hover:opacity-100">
      ...
      <div className="p-6 rounded-lg bg-gray-200 dark:bg-gray-800 shadow space-y-3">
        ...
        <p>
          ...
          {licencia.estado === "trial" && (
            <span className="bg-blue-200 text-blue-800 dark:bg-blue-900 dark:text-blue-300
                             px-2 py-1 rounded text-xs font-semibold">
              Trial
            </span>
          )}
          {licencia.estado === "bloqueada" && (
            <span className="bg-red-200 text-red-800 dark:bg-red-900 dark:text-red-300
                             px-2 py-1 rounded text-xs font-semibold">
              Bloqueada
            </span>
          )}
