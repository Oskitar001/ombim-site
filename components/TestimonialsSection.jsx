export default function TestimonialsSection() {
  return (
    <section className="reveal max-w-3xl mx-auto text-center mb-24 px-6">
      ...
      <blockquote className="bg-white dark:bg-[#1a1a1a] p-6 rounded-xl shadow-soft border border-gray-200 dark:border-gray-700">
        ...
        <footer className="mt-4 text-gray-600 dark:text-gray-400 font-medium">
