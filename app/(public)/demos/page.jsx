...
export default function DemosPage() {
  return (
    <section className="py-24 max-w-5xl mx-auto px-6 bg-white dark:bg-[#111]">
      <h1 className="text-4xl font-bold text-center mb-12 text-gray-900 dark:text-gray-100">
        Demos y Automatizaciones
      </h1>

      <p className="text-gray-700 dark:text-gray-300 text-center mb-16 max-w-3xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        {/* EJEMPLO 1 */}
        <div className="bg-white dark:bg-[#1a1a1a] shadow rounded-xl p-6 border border-gray-200 dark:border-gray-700">
      ...
      <p className="text-center text-gray-600 dark:text-gray-300 mt-16">
