...
export default function Footer() {
  return (
    <footer
      className="
        mt-32 py-14
        bg-light-bgSoft text-light-text
    ...
    >
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li className="text-gray-600 dark:text-gray-300">📍 España</li>
          </ul>
          ...
          <div className="flex gap-5 mt-5">
            ...
            <a
              ...
              aria-label="LinkedIn"
              className="transition text-gray-600 dark:text-gray-300 hover:text-[#0A66C2]"
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className="transition text-gray-600 dark:text-gray-300 hover:text-[#25D366]"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="text-center text-gray-500 dark:text-gray-400 text-sm mt-10 border-t border-light-border dark:border-dark-border pt-6">
